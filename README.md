...
AI-powered cybersecurity system for detecting phishing emails using Machine Learning, Flask, SQLAlchemy, and real-time threat analysis dashboard.
...
📊 Interactive web dashboard (Flask UI)<br>
...
🌐 URL & website threat detection<br>
📡 Real-time monitoring dashboard<br>
☁️ Cloud deployment (AWS / Azure)<br><br>
